...
?>
<p>Views: {{ $singleNews->nofn_readers }}</p>
                ...
                <div class="breadcrumb-wrap py-2">
                    <nav aria-label="breadcrumb " class="breadcrumbs large-font">
                        <ol class="breadcrumb">
                            ...
                            <!-- TODO dynamic   header -->
                            <li class="breadcrumb-item active" aria-current="page">{{$singleNews->news_headline}}
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="dheading my-2">
                    ...
                    <!-- <h2 class="DsubHead h5">বিকেলে সোহরাওয়ার্দী উদ্যানে জনসভা</h2> -->
                    <!-- TODO dynamic   header -->
                ...
                <div class="DNewsImg">
                    <img class="{{$file_exist?'img-fluid w-100':''}}"
                        data-src="{{ asset('backend/images/news-himages/'.$singleNews->news_title_image) }}"
                        src="{{ asset('backend/images/news-himages/'.$singleNews->news_title_image) }}"
                        alt="{{$singleNews->title_image_courtecy}}" title="{{$singleNews->news_headline}}"
                        style="width:100% ;background-size: cover; background-position: center;  background-repeat: no-repeat;">
                    <!-- <p class="text-center">বিএনপির মহাসচিব মির্জা ফখরুল ইসলাম আলমগীর। ফাইল ছবি</p> -->
                ...
                <!-- <div class="col-lg-6 d-flex border"> -->
                <!-- <div class="align-self-stretch justify-content-center"> -->
                <!-- <div class="writter ">
                                <span>অনলাইন ডেস্ক</span>
                            </div> -->
                ...
                <!-- social share  -->
                <div class="d-flex mt-3 align-items-center justify-content-between flex-wrap gap-2">

                    <div class="writter">অনলাইন ডেস্ক</div>
                    ...
                    <div class="col-md-12">
                        <div class="DetailsAdd d-flex justify-content-center">
                            ...
                            <section class="container">
                                <div class="adv-row">
                                    <img class="w-100 img-fluid" src="{{ asset('backend/images/advertise/' . $details_banner4->adimage) }}" style="width: 100%;height: 150px; background-size: cover; background-position: center;  background-repeat: no-repeat;" alt="" loading="lazy" />
                                </div>
                            </section>
                            @endif
                        </div>
                ...
                <section class="CatNewsListArea mb-5">
                    ...
                    <div class="CatNewsListWrap mt-3">
                        <div class="row gx-4">
                            <!-- TODO dynamic news -->
                                            ...
                                            <div class="col-lg-5 col-5">
                                                <div class="CatNewsListImg">
                                                    <img data-src="{{ asset('backend/images/news-himages/'.$news->news_title_image) }}"
                                                        ...
                                                        alt="{{$news->title_image_courtecy}}"
                                                        title="{{$news->news_headline}}" class="img-fluid w-100"
                ...
                <div class="row MobileHide d-none d-lg-flex ">
                    <div class="col-12">
                        <div class="d-flex justify-content-center mb-5">
                            ...
                            <section class="container">
                                <div class="adv-row">
                                    <img src="{{ asset('backend/images/advertise/' . $details_banner4->adimage) }}" style="width: 100%;height: 150px; background-size: cover; background-position: center;  background-repeat: no-repeat;" alt="" loading="lazy" />
                                </div>
                            </section>
                            @endif
                            <!-- TODO remove line -->
            ...
            <div class="col-lg-3">
                <div class="dAddImg-wrap MobileHide  d-lg-flex flex-column">
                    <div class="DRightSideAdd mt-3 mb-4 col-12">
                        ...
                        <div class="adv-col flex-grow-1 ">
                            <img src="{{ asset('backend/images/advertise/' . $details_banner1->adimage) }}" style="width: 100%;height: 300px; background-size: cover; background-position: center;  background-repeat: no-repeat;" alt="" loading="lazy" />
                        </div>
                        @endif
                        <!-- TODO remove line -->
                    </div>

                    <div class="DRightSideAdd col-12" style="margin-top: 60px;">
                        <!-- TODO remove line -->
                        @if(!empty($details_banner2))
                        <div class="adv-col flex-grow-1 ">
                            <img src="{{ asset('backend/images/advertise/' . $details_banner2->adimage) }}" style="width: 100%;height: 300px; background-size: cover; background-position: center;  background-repeat: no-repeat;" alt="" loading="lazy" />
                        </div>
                        @endif
                        <!-- TODO remove line -->
                ...
                <div class="DlastNews">
                                    ...
                                    <div class="col-5">
                                        <div class="dLastNewsImg">
                                            <img class="img-fluid w-100"
                                                data-src="{{asset('backend/images/news-himages/'.$news->news_title_image)}}"
                                                src="{{asset('backend/images/news-himages/'.$news->news_title_image)}}"
                                                alt="{{$news->title_image_courtecy}} &nbsp;&nbsp;"
                                                title="{{$news->news_headline}} &nbsp;&nbsp;" loading="lazy"
                                                style="background-size: cover; background-position: center;  background-repeat: no-repeat;">
                                        </div>
                                    </div>
                                    <div class="col-7">
                    ...
                    <div class="DreadMoreBtn">
                        <a class="fs-5 fw-semibold" href="{{route('latestNews')}}">আরও পড়ুন <i
                ...
                <div class="DRightSideAdd mt-4 mb-4 MobileHide d-none d-lg-flex">
                    ...
                    <div class=" container">
                        ...
                        <div class="adv-col">
                            <img src="{{ asset('backend/images/advertise/' . $details_banner3->adimage) }}"
                                style="height: 300px;width: 100%;" alt="" loading="lazy" />
                        </div>
                        @endif
            ...
            <div class="col-md-12">
                <div class="DetailsAdd d-flex justify-content-center">
                    ...
                    <div class=" container">
                        @if(!empty($details_banner4))
                        <div class="adv-row">
                            <img src="{{ asset('backend/images/advertise/' . $details_banner4->adimage) }}" style="width: 100%;height: 150px" alt="" loading="lazy" />
                        </div>
                        @endif
                    </div>
