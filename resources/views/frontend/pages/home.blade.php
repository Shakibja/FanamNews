...
<section class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 d-flex flex-column">
                ...
                @if(!empty($banner_right))
                    <div class="adv-col" >
                    <img src="{{ asset('backend/images/advertise/' . $banner_right->adimage) }}" style="height: 300px;width: 100%;" alt="Advertise" />
                    </div>
                @endif
    ...
    <section class="container">
        <div class="adv-row" >
        <img src="{{ asset('backend/images/advertise/' . $banner_show->adimage) }}" style="width: 100%;height: 150px;" alt="Advertise"  />
         </div>
    </section>
    @endif
