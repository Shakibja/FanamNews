        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-center mt-4">
                    ...
                    <div class=" container">
                        <div class="adv-row"> 
                        <img src="{{ asset('backend/images/advertise/' . $category_banner1->adimage) }}" style="width: 100%;height: 150px; " alt="Advertise" loading="lazy"/>
                    ...
                    <div class="col-md-3">
                        <div class="DRightSideAdd mt-3 mb-4 col-12">
                            ...
                            @if(!empty($category_banner2))
                                <div class="adv-col" >
                                <img src="{{ asset('backend/images/advertise/' . $category_banner2->adimage) }}" style="height: 300px;width: 100%;" alt="Advertise" loading="lazy"/>
                                </div>
                            @endif
            ...
            <div class="ad-area d-flex justify-content-center">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-center mt-4">
                        ...
                        <div class=" container">
                            <div class="adv-row"> 
                            <img src="{{ asset('backend/images/advertise/' . $category_banner3->adimage) }}" style="width: 100%;height: 150px; " alt="Advertise" loading="lazy"/>
